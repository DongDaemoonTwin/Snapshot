package com.snapshot.weatherwallpaper
...
import com.snapshot.weatherwallpaper.model.WeatherRepository
import com.snapshot.weatherwallpaper.model.WeatherStore
import com.snapshot.weatherwallpaper.wallpaper.WeatherWallpaperService
import com.snapshot.weatherwallpaper.widget.WeatherWidgetProvider
...
class MainActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        layout.addView(TextView(this).apply {
            text = "Snapshot Weather Wallpaper"
            textSize = 24f
            gravity = Gravity.CENTER
            setPadding(0, 0, 0, 20)
        })
